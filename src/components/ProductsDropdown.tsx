...
const ProductsDropdown: React.FC<ProductsDropdownProps> = ({ 
  ...
  // Курсы по анимации - быстрый доступ к основным категориям
  const categories = [
    { id: 1, name: 'Animation Basics', icon: '✍️', productId: 1 },
    { id: 2, name: 'Character Animation', icon: '🔢', productId: 3 },
    { id: 3, name: '3D Animation', icon: '🔄', productId: 5 },
    { id: 4, name: 'Animation Tools', icon: '⚙️', productId: 10 },
  ...
  return (
    ...
    >
      <DropdownContent>
        ...
        <FeaturedSection>
          <FeaturedTitle>Featured Animation Courses</FeaturedTitle>
          <ProductGrid>
