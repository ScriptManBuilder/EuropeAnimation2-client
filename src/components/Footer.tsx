  ...
  return (
    <FooterWrapper>
      <FooterContent>
        <FooterMain>
          <FooterSection>
            ...
            <ul>
              ...
              <li><Link to="/products">Animation Courses</Link></li>
          ...
          <MoreAboutSection>
            ...
            <PromoCards>
              <PromoCard href="/products">
                <img src="/images/animation_1.jpg" alt="Animation Courses" />
                <PromoCardContent>
                  <h4>Animation Courses</h4>
                  <p>Master Digital Animation</p>
                </PromoCardContent>
              </PromoCard>
              ...
              <PromoCard href="/about">
                ...
                <PromoCardContent>
                  <h4>About Us</h4>
                  <p>Animation Education Excellence</p>
                </PromoCardContent>
              </PromoCard>
        ...
        <FooterBottom>
          <Copyright>
            Copyright  2025 Elariosso Digital. All rights reserved. | Premium Animation Education & Training Courses
          </Copyright>
        </FooterBottom>
      </FooterContent>
    </FooterWrapper>
