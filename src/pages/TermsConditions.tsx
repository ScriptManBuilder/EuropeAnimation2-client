    ...
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          the terms and provisions of this agreement. These terms apply to all digital animation courses, educational content, and 
      ...
      <Section>
        ...
        <Paragraph>
          This animation course platform is operated by {COMPANY_INFO.name}. 
      ...
      <Section>
        <SectionTitle>3. Digital Animation Course Pricing</SectionTitle>
        <Paragraph>
          Our animation courses are available at the following price points: {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, and {formatPrice(99.99)}. 
      ...
      <Section>
        ...
        <Paragraph>
          We accept major credit and debit cards for animation course purchases. Your payment information is processed securely through our payment processors using 256-bit SSL encryption.
        </Paragraph>
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "ANIMATION COURSES" or "ANIMATION.ECOURSES". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased animation courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All animation course content, including videos, text, images, and downloadable materials, are the intellectual property of 
      ...
      <Section>
        ...
        <Paragraph>
          Due to the digital nature of our animation courses, all sales are final. However, we offer a 7-day satisfaction guarantee. 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our animation course content to reflect the latest developments in animation, motion graphics, and digital animation. 
      ...
      <Section>
        ...
        <Paragraph>
          {COMPANY_INFO.name} provides Animation courses for educational purposes only. We make no guarantees about 
