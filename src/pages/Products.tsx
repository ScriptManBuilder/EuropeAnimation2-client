...
const Products: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: 'Animation Basics', name: 'Animation Basics' },
    { id: 'Maya Interface', name: 'Maya Interface' },
    { id: 'Maya Tools', name: 'Maya Tools' },
    { id: 'Animation Fundamentals', name: 'Animation Fundamentals' },
    { id: 'Animation Tools', name: 'Animation Tools' },
    { id: 'Animation Principles', name: 'Animation Principles' },
    { id: 'Advanced Animation', name: 'Advanced Animation' },
    { id: 'Character Animation', name: 'Character Animation' },
    { id: 'Advanced Character Animation', name: 'Advanced Character Animation' },
    { id: 'Professional Animation', name: 'Professional Animation' },
  ...
  return (
    <ProductsWrapper>
      <Container>
        <PageHeader>
          <PageTitle>Animation Learn Collection</PageTitle>
          <PageSubtitle>Master Maya 3D Animation with our comprehensive animation fundamentals and advanced technique video library</PageSubtitle>
        </PageHeader>
