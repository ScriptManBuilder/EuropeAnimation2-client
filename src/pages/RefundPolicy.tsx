...
const RefundPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          At {COMPANY_INFO.name}, we stand behind the quality of our animation courses and want you to be satisfied with your learning experience. 
          This refund policy outlines the terms and conditions for refunds on our digital animation course purchases.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          We offer a 7-day satisfaction guarantee on all animation course purchases. You may request a refund within 7 days 
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your animation course purchase:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          You will see "ANIMATION COURSES" or "ANIMATION.ECOURSES" as the refund descriptor on your statement.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit for a different animation course that better suits your needs<br/>
