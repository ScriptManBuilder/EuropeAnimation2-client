...
const Account: React.FC = () => {
  ...
  const renderCoursesSection = () => {
    ...
    if (!isTestAccount) {
      return (
        <div>
          <SectionTitle>MY ANIMATION COURSES</SectionTitle>
          
          <InfoCard>
            <EmptyOrdersText>
              📚 Your purchased ANIMATION courses will appear here after successful payment.
            </EmptyOrdersText>
            <EmptyOrdersText style={{ fontSize: '1rem', marginTop: '1rem', opacity: 0.8 }}>
              Once you purchase any Animation course, you'll have lifetime access to all course materials, 
              including videos, downloadable resources, and future updates.
            </EmptyOrdersText>
            <EmptyOrdersButtonWrapper>
              <ShoppingButton as={Link} to="/products" variant="primary">
                Browse Animation Courses
              </ShoppingButton>
            </EmptyOrdersButtonWrapper>
          </InfoCard>
        </div>
    ...
    return (
      <div>
        ...
        <div style={{ 
          ...
          }}>Continue your Animation mastery journey</p>
          <div style={{ 
            display: 'flex', 
