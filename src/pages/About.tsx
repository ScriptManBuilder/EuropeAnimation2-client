  ...
  return (
    <AboutWrapper>
      <HeroSection ref={heroRef}>
        ...
        <LogoContainer>
          <MainLogo>ANIMATIONLEARN</MainLogo>
        </LogoContainer>
        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('ANIMATIONLEARN')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower animators worldwide with professional animation education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform creative concepts into practical animation skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted animation courses cover motion principles, character animation, 2D/3D techniques, motion design, and visual effects. Each course is designed with hands-on projects, real-world applications, and professional techniques to help you master digital animation and advance your career in the animation industry.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Animation Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive animation learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
        ...
        <Container>
          <StatsContainer>
            <StatsTitle ref={setElementRef(20)}>
              {splitTextToWords('Transforming Careers Through Animation Education')}
            </StatsTitle>
            ...
            <Timeline>
              <TimelineItem ref={setElementRef(13)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    AnimationLearn was founded with a vision to democratize Animation education 
              ...
              <TimelineItem ref={setElementRef(17)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    ...
                    helping students master both 2D and 3D animation techniques.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(18)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    ...
                    animation education platform by major creative industry publications.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(19)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    Continuing to lead animation education with emerging techniques, modern animation practices, 
      ...
      {/* Animation Education Team Section */}
      <LeadershipSection>
        <Container>
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                <LeaderImage>
                  <img src="/images/animation_1.jpg" alt="Education Team" />
                  <LeaderOverlay>
                    <LeaderRole>Education & Course Team</LeaderRole>
                  </LeaderOverlay>
                </LeaderImage>
                <LeaderInfo>
                  <LeaderName>Animation Team</LeaderName>
                  <LeaderTitle>Animation Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about digital animation and dedicated to making animation education accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of digital animation.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Animation Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in animation education, constantly updating 
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Animation should be accessible to everyone. We create a supportive environment 
              ...
              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Animation Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest animation software and tools, 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical animation skills that you can apply immediately 
                  in real projects, from character animation to motion graphics and visual effects.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of animation artists with world-class education, 
                practical skills, and real-world projects that drive creative career success. 
                We believe that by making animation education accessible and excellent, we can help 
                students create amazing animated content while creating opportunities for everyone 
                to participate in the digital animation revolution.
              </MissionStatementText>
            </MissionStatement>
          </ValuesContainer>
        </Container>
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            <ModalImage>
              <img src="/images/animation_2.jpg" alt="Education Team" />
            </ModalImage>
          
            <ModalSubtitle>Animation Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional animation experts is dedicated to 
            transforming creative careers through comprehensive digital animation education.
            <br /><br />
            We believe animation should be accessible to everyone, from complete beginners to advanced animators looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex animation concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of digital animation and empower them 
            with the knowledge and skills needed to create stunning animated content and advance their creative careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your animation journey or looking to master advanced animation techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of digital animation together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
